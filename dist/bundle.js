...
/******/ 	__webpack_require__.p = "http://localhost:1122/";
/******/
...
var Upload = function () {
	function Upload(options) {
		...
		this.defaults = {
			...
			onTypeError: function onTypeError() {},
			onLengthError: function onLengthError() {},
			onDimensionError: function onDimensionError() {},
			onCancel: function onCancel() {},
			onCancelAll: function onCancelAll() {},
	...
	_createClass(Upload, [{
		...
		value: function uploadFile(file) {
			...
			var list = this.list;
			var object = this.createDomFromString(this.option.item);
			list.appendChild(object);

			var bar = object.querySelector(this.option.progressBar);
			var progressor = object.querySelector(this.option.progressor);
			progressor.innerHTML = '0%';

			var size = parseInt(file.size / 1024, 10);
			var total = void 0;
			var index = Array.prototype.slice.call(list.children).indexOf(object);
			var response = void 0;
			...
			xhr.upload.onprogress = function (e) {
				...
				_this.option.onProgress.call(_this, object);
			};
			...
			xhr.onload = function () {
				...
				response = _this.sortResponse(xhr.responseText);
				_this.option.onComplete.call(_this, object, response);
				_this.completedCollection.push(object.index);
				if (_this.completedCollection.length === _this.ongoingCollection.length) {
					_this.option.onQueueComplete.call(_this);
				}
			};
		...
		value: function validate(file) {
			...
			this.getImageSize(file, function (file, width, height) {

				if (_this2.option.minWidth > 0 && width < _this2.option.minWidth) {
					_this2.option.onDimensionError.call(_this2, { name: file.name, width: width, height: height });
					valid = false;
				}
				if (_this2.option.minHeight > 0 && height < _this2.option.minHeight) {
					_this2.option.onDimensionError.call(_this2, { name: file.name, width: width, height: height });
					valid = false;
				}
				if (itemCount >= _this2.option.maxLength) {
					//needed double check items length
					_this2.option.onLengthError.call(_this2, itemCount);
					valid = false;
				}
			});
		...
		key: 'traverseFile',
		value: function traverseFile(files) {
		...
		key: 'isImage',
		value: function isImage(img) {}
	}, {
		key: 'createDomFromString',
		value: function createDomFromString(string) {
		...
		key: 'getImageSize',
		value: function getImageSize(file, callback) {
...
module.exports = {
	...
	'oldFF-globalStorage': __webpack_require__(12),
	'oldIE-userDataStorage': __webpack_require__(13),
	'cookieStorage': __webpack_require__(9),
	'sessionStorage': __webpack_require__(14),
...
exports.bindDragEventToRecoverElement = bindDragEventToRecoverElement;
exports.saveElement = saveElement;
exports.recoverElement = recoverElement;
exports.LoadImageFromServer = LoadImageFromServer;
exports.deleteImageFromServer = deleteImageFromServer;
...
var _domDrag = __webpack_require__(1);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function bindDragEventToRecoverElement() {
	var dragEls = document.getElementsByClassName('drag');
	Array.from(dragEls).map(function (i) {
		return _domDrag.Drag.init(i);
	});
}
function saveElement(canvas) {
	var elementStorage = [];
	var els = document.querySelector(canvas).children;
	els = Array.from(els);
	els.map(function (i) {
		var ob = {};
	...
	_store2.default.set('oldSession', { 1: elementStorage });

	// console.log(elementStorage)
}
function recoverElement() {
	if (_store2.default.get('oldSession')) {
		var a = _store2.default.get('oldSession');
		// console.log(a[1])
		a[1].map(function (i) {
			if (i.type === 'span') {
				var image = (0, _jquery2.default)('<span tabindex="0" class="drag dragThumb" style="position:absolute" />');
				image.css('background-image', 'url(' + i.value + ')');
				_domDrag.Drag.init(image[0]);
				image[0].style.left = i.x + 'px';
				image[0].style.top = i.y + 'px';
				(0, _jquery2.default)('.block').append(image);
			}
			if (i.type === 'input') {
				var input = (0, _jquery2.default)('<input type="text" class="drag" style="position:absolute" value="' + i.value + '" />');
				_domDrag.Drag.init(input[0]);
				input[0].style.left = i.x + 'px';
				input[0].style.top = i.y + 'px';
				(0, _jquery2.default)('.block').append(input);
			}
		});
	}
}
function LoadImageFromServer() {
	return _jquery2.default.get('/uploads', function (res) {
		return res;
	});
}
function deleteImageFromServer(url, id) {
	return _jquery2.default.post(url, { id: id }, function (r) {
		return r;
	});
}
...
window.onload = function () {
	...
	LoadImageFromServer().then(function (res) {
		// console.log(res)
		res.map(function (i) {
			var id = getFileNameFromUrl(i);
			var img = (0, _jquery2.default)('<span class="thumb">').css('background-image', 'url(' + i + ')');
			var deleteBtn = (0, _jquery2.default)('<a class="del" id="' + id + '" >delete</a>');
			var li = (0, _jquery2.default)('<li></li>').append(img);
			li.append(deleteBtn);
			(0, _jquery2.default)('.list-unstyled').append(li);
		});
	});

	// init upload script
	var up = new _upload2.default({
		url: '/uploads',
		list: '.list-unstyled',
		onComplete: function onComplete(object, response) {
			if (response == 'success') {
				var img = (0, _jquery2.default)('<span class="thumb">').css('background-image', 'url(' + 'uploads/' + object.name + ')');
				var deleteBtn = (0, _jquery2.default)('<a class="del" id="' + object.name + '" >delete</a>');
				(0, _jquery2.default)(object).append(img);
				(0, _jquery2.default)(object).append(deleteBtn);
				(0, _jquery2.default)(object).find('.progress-container').remove();
			}
		}
	});
	...
	(0, _jquery2.default)('.image').on('click', '.del', function (e) {
		var id = (0, _jquery2.default)(e.target).attr('id');
		// post the id of the image to server for deletion
		deleteImageFromServer("/delete", id).then(function (r) {
			if (r === 'success') {
				(0, _jquery2.default)(e.target).parents('li').remove();
			}
		});
	});

	// addtext button clicked
	(0, _jquery2.default)('#addText').on('click', function () {
		var input = (0, _jquery2.default)('<input type="text" class="drag" style="position:absolute" value="text" />');
	...
	// image clicked
	(0, _jquery2.default)('ul').on('click', '.thumb', function () {
		var imgUrl = this.style.backgroundImage.slice(4, -1).replace(/"/g, "");
		// console.log(imgUrl)
		var image = (0, _jquery2.default)('<span tabindex="0" class="drag dragThumb" style="position:absolute" />');
	...
	(0, _jquery2.default)('.block').on('click', '.drag', function () {
	...
	(0, _jquery2.default)(document).on('keyup', function () {
		saveElement('.block');
	});
